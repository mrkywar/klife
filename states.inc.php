...
$machinestates = array(
    ...
    ST_PLAYER_TURN => array(
    		"name" => "playerTurn",
    		"description" => clienttranslate('${actplayer} must draw, take and play the last card discarded, quit or divorce'),
    		"descriptionmyturn" => clienttranslate('${you} must choose among'),
    		"type" => "activeplayer",
